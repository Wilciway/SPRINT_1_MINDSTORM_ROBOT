...
class WSHandler(tornado.websocket.WebSocketHandler):
	...
	def on_message(self, message):      # receives the data from the webpage and is stored in the variable message
		...
		if c == '2' :
		  ...
		  BP.set_motor_power(BP.PORT_C, 200)  #Set the speed of MotorA (-255 to 255)
		  BP.set_motor_power(BP.PORT_B, 200)  #Set the speed of MotorD (-255 to 255)
		elif c == '8' :
		  print "Running Reverse"
		  BP.set_motor_power(BP.PORT_C, -200)  
